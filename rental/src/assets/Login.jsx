        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-xl font-bold tracking-tight text-white sm:text-3xl sm:leading-none">
                Login to Access the Property Listing  <br className="hidden md:block" />{' '}
            ...
            <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
              <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                <h3 className="mb-4 text-xl font-bold sm:text-center sm:mb-6 sm:text-3xl ">
                  Log <span className="text-teal-400">In</span>                </h3>
                <form>
                  ...
                  <p className="text-xs text-gray-600 sm:text-sm">
                    Don't have an account ?{' '} <Link to="/register" className='text-blue-400 font-medium'>Register</Link>
                  </p>
                </form>
              </div>
            </div>
